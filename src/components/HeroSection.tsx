...
function QpsCardGraphic({ isHovered = false }: { isHovered?: boolean }) {
  return (
    <div className="h-[180px] relative rounded-[16px] shrink-0 w-full overflow-hidden bg-black border border-[#2a2a2a] flex items-center justify-center isolate select-none">
      ...
      {/* 20px Subtle Grid Texture (1px stroke, 0.07 opacity) placed on top of shader */}
      <div 
...
function PayAsYouGoGraphic({ isHovered = false }: { isHovered?: boolean }) {
  return (
    <div className="h-[180px] relative rounded-[16px] shrink-0 w-full overflow-hidden bg-black border border-[#2a2a2a] flex items-center justify-center isolate select-none">
      ...
      />
      {/* 20px Subtle Grid Texture (1px stroke, 0.07 opacity) */}
      <div 
...
function QpsPlanCard() {
  ...
  return (
    <a 
      ...
      className="w-full md:flex-[1_0_0] md:min-w-px relative rounded-[24px] bg-white border border-[#E5E7EB] hover:border-[#D1D5DB] hover:shadow-[0px_12px_28px_rgba(0,0,0,0.08)] transition-all duration-300 ease-out block overflow-hidden cursor-pointer select-text no-underline text-inherit"
    >
