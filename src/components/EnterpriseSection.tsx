...
function FigmaCardHoverGlow({ idPrefix = "card_glow" }: { idPrefix?: string }) {
  return (
    <div 
      className="absolute top-[-22px] left-[-64.34px] w-[402px] h-[79px] pointer-events-none select-none z-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 overflow-visible"
    >
