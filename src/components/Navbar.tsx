  ...
  return (
    <a href="#" className="content-stretch flex items-center relative shrink-0" aria-label="Octen AI Home">
      <svg width="106" height="36" viewBox="0 0 106 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M52.8957 18.5076V22.1442C52.8957 24.2782 54.6287 26.0112 56.7627 26.0112H62.8052V23.3979H56.7627C56.0713 23.3979 55.509 22.8356 55.509 22.1442V18.5076C55.509 17.8163 56.0713 17.254 56.7627 17.254H62.8052V14.6406H56.7627C54.6287 14.6406 52.8957 16.3736 52.8957 18.5076Z" fill="white"/>
        <path d="M69.3778 11.5802H66.7644V14.6406H64.1695V17.254H66.7644V21.9783C66.7644 24.2045 68.5758 26.0112 70.802 26.0112H73.6965V23.3979H70.802C70.0184 23.3979 69.3778 22.7618 69.3778 21.9737V17.2494H73.6919V14.636H69.3778V11.5802Z" fill="white"/>
        <path d="M46.3877 11.5664H42.0367C39.2021 11.5664 36.8976 13.8709 36.8976 16.7101V20.8675C36.8976 23.7021 39.2021 26.0113 42.0413 26.0113H46.3923C49.2269 26.0113 51.536 23.7067 51.536 20.8675V16.7101C51.536 13.8756 49.2315 11.5664 46.3923 11.5664H46.3877ZM48.9273 20.8675C48.9273 22.2687 47.7888 23.4071 46.3877 23.4071H42.0367C40.6355 23.4071 39.4971 22.2687 39.4971 20.8675V16.7101C39.4971 15.309 40.6355 14.1705 42.0367 14.1705H46.3877C47.7888 14.1705 48.9273 15.309 48.9273 16.7101V20.8675Z" fill="white"/>
        <path d="M95.184 13.9493H92.3725C90.0126 13.9493 88.0906 15.8713 88.0906 18.2312V26.0159H90.7777V18.2312C90.7777 17.3508 91.4921 16.6364 92.3725 16.6364H95.184C96.0643 16.6364 96.7787 17.3508 96.7787 18.2312V26.0159H99.4658V18.2312C99.4658 15.8713 97.5439 13.9493 95.184 13.9493Z" fill="white"/>
        <path d="M82.8869 13.9032H78.9093C76.7937 13.9032 75.0699 15.627 75.0699 17.7426V22.1673C75.0699 24.2828 76.7891 26.002 78.9047 26.0066L86.1041 26.0159V23.3288L78.9093 23.3195C78.2733 23.3195 77.757 22.8033 77.757 22.1673V21.8677L84.9841 20.5034C85.9935 20.3144 86.7263 19.4295 86.7263 18.4017V17.7426C86.7263 15.627 85.0025 13.9032 82.8869 13.9032ZM84.0392 17.95L77.757 19.1345V17.7426C77.757 17.1065 78.2733 16.5903 78.9093 16.5903H82.8869C83.523 16.5903 84.0392 17.1065 84.0392 17.7426V17.95Z" fill="white"/>
        <defs>
...
export default function Navbar() {
  return (
    <div className="absolute bg-transparent h-[70px] left-0 top-0 w-full z-50 flex items-center justify-center px-4 md:px-[40px] border-b border-white/10" data-name="Header Navigation">
