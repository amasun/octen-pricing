...
export default function ApiExplorer() {
  ...
  return (
    <div className="bg-white content-stretch flex flex-col items-center pb-[120px] pt-[40px] relative shrink-0 w-full max-w-[1320px] px-4 box-border" id="api-pricing">
      {/* Title Header */}
